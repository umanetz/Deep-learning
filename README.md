...
<img src="./img/outputSoft.png" alt="drawing" width="250"/> <img src="./img/norm_Sigmoid.png" alt="drawing" width="250"/>

Видно, что резко уменьшается значение Sigmoid и это влияет на градиенты. 
В последнем слое мы нормировали на значения SoftMax, т.к. у нас multy-label классификация. Насамом деле, записей, относящихся к разным классам, около 5тыс. Мы можем пренебречь этим и нормировать на Sigmoid, тем самым давая наибольшее значение однному из таргетов. В данном случае градиенты не обнуляются. 
