...
В качестве архитектуры была взята GCNN из статьи  *https://arxiv.org/pdf/1710.00343.pdf*. Было изменено количество каналов со 128 до 64 (иначе не хватает памяти) в сверточном, в качестве активации у  рекурентного слояиспользовалась только сигмоида. 
